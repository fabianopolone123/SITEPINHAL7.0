...
- [x] Corre��o do asterisco de obrigat�rio: adicionado script (`required-asterisk.js`) para marcar campos obrigat�rios em responsavel/diretoria/aventureiro de forma compat�vel com navegadores sem suporte pleno a `:has`.
