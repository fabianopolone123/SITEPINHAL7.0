...
- [x] Ajustados textos para padrao pt-BR com acentos (UI e mensagens), incluindo In�cio, Usu�rios, Voc� e Notifica��es.
- [x] Formul�rio de aventureiro agora pede confirma��o antes de executar `Salvar e confirmar` ou `Adicionar outro aventureiro`, reduzindo envios acidentais.
...
- [x] Revis�o de textos dos templates com padroniza��o pt-BR: ajustes de acentua��o em telas de usu�rios/detalhes e mensagens da tela WhatsApp.
- [x] Tela de login ajustada: "Pinhal J�nior" com acento e subt�tulo simplificado para "Bem-vindo".
- [x] Campos obrigat�rios dos formul�rios (respons�vel, diretoria e aventureiro) agora exibem `*` automaticamente ao lado do r�tulo.
