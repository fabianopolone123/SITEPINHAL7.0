    ...
    def get(self, request, event_id, file_kind):
        ...
        if kind == 'bat':
            ...
            script = '\r\n'.join([
                ...
                '',
                'set "_PORT=USB001"',
                'set /p "_PORT=Informe a porta USB da impressora [USB001]: "',
                'if "%_PORT%"=="" set "_PORT=USB001"',
                '',
                'powershell -NoProfile -ExecutionPolicy Bypass -File "%_PS1%" -DriverDir "%~dp0POS58 DRIVER" -PortName "%_PORT%"',
                'if %errorlevel% neq 0 (',
